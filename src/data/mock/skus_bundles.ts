...
export const mockBundleSkus: ProductSku[] = [
  {
    ...
    isSerialized: false,
    translations: {
      en: { name: 'Quick Service Bundle - Standard' },
      zh: { name: '快餐全能创业套装 - 标准版' }
    }
  },
  {
    id: 1101,
    productId: 152,
    skuCode: 'SKU-BND-152-1',
    name: '正餐豪华数字化套装 - 标准版',
    billingModel: 'one_time',
    billingTerm: 'none',
    billingTiming: 'in_advance',
    ...
    isSerialized: false,
    translations: {
      en: { name: 'Full Service Bundle - Standard' },
      zh: { name: '正餐豪华数字化套装 - 标准版' }
    }
  },
  {
    id: 1102,
