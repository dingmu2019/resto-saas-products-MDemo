...
export const mockBundleGroups: BundleGroup[] = [
  ...
  { id: 6, bundleSkuId: 1091, name: '移动端软件', description: '移动端点餐核心软件', minSelections: 1, maxSelections: 1, sortOrder: 1, isMutuallyExclusive: true, allowMultipleQtyPerItem: false },
  { id: 7, bundleSkuId: 1091, name: '移动外设', description: '便携式打印机等', minSelections: 1, maxSelections: 2, sortOrder: 2, isMutuallyExclusive: false, allowMultipleQtyPerItem: true },

  // Kitchen Efficiency Bundle (1101)
  { id: 8, bundleSkuId: 1101, name: '厨房显示系统', description: 'KDS 核心组件', minSelections: 1, maxSelections: 2, sortOrder: 1, isMutuallyExclusive: false, allowMultipleQtyPerItem: true },
  { id: 9, bundleSkuId: 1101, name: '配套打印', description: '厨房专用打印机', minSelections: 1, maxSelections: 1, sortOrder: 2, isMutuallyExclusive: true, allowMultipleQtyPerItem: false },

  // FSR Premium Bundle (1111)
  { id: 10, bundleSkuId: 1111, name: '高端软件套装', description: '全功能正餐版', minSelections: 1, maxSelections: 1, sortOrder: 1, isMutuallyExclusive: true, allowMultipleQtyPerItem: false },
  { id: 11, bundleSkuId: 1111, name: '高端硬件套装', description: '双屏 POS 终端', minSelections: 1, maxSelections: 1, sortOrder: 2, isMutuallyExclusive: true, allowMultipleQtyPerItem: false },
  { id: 12, bundleSkuId: 1111, name: '尊享服务', description: '年度技术支持', minSelections: 1, maxSelections: 1, sortOrder: 3, isMutuallyExclusive: true, allowMultipleQtyPerItem: false },
];
