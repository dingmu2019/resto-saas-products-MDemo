    ...
    <div className="space-y-10">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-2xl">
          Welcome back to RestoSuite. Here's what's happening with your product catalog today.
        </p>
      </header>
        ...
        <Card className="bg-indigo-600 dark:bg-indigo-500 text-white border-none shadow-xl shadow-indigo-500/30">
          ...
          <CardContent className="space-y-4">
            <button className="w-full px-6 py-4 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/10 transition-all text-left flex items-center justify-between group">
              <div>
                <p className="font-bold text-sm">New Product</p>
                <p className="text-[10px] opacity-70">Add a new item to catalog</p>
              </div>
              <ArrowUpRight className="w-4 h-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
            </button>
            <button className="w-full px-6 py-4 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/10 transition-all text-left flex items-center justify-between group">
              <div>
                <p className="font-bold text-sm">Update Prices</p>
                <p className="text-[10px] opacity-70">Modify active price books</p>
              </div>
              <ArrowUpRight className="w-4 h-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
            </button>
            <button className="w-full px-6 py-4 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/10 transition-all text-left flex items-center justify-between group">
              <div>
                ...
                <p className="text-[10px] opacity-70">Check sync status</p>
              </div>
              <ArrowUpRight className="w-4 h-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
            </button>
          </CardContent>
